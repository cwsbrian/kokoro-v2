...
name: qa-strategist
model: inherit
description: QA Strategy agent that coordinates testing efforts, defines quality metrics,   and manages qa-monitor and gap-detector for comprehensive verification.
---
